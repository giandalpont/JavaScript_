(function(){
    ...
    */
    ...
    console.log('isOperatorValid', isOperatorValid('') )
    ...
    */
    function showErrorMessage(operator){
        return `peração "${operator}" não permitida!`
    }
    ...
    */
    ...
    operationSignal = '/';
    var dividion = calculator( operationSignal );
    if ( dividion ){
        number1 = 100;
        number2 = 5;
        console.log( showOperationMessage( operationSignal, number1, number2 ), dividion( number1, number2 ) );
    }
    else{
        console.log( showErrorMessage( operationSignal ) );
    }
